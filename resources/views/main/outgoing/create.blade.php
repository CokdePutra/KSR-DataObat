    ...
    <script>
        function getCart() {
            ...
            if (!localStorage.getItem('cart')) {
                ...
                $.each(JSON.parse(localStorage.getItem('cart')), function(index, cart) {
                    ...
                    list += '</td>';
                    // list += '<td>' + cart.quantity + '</td>';
                    // list += '<td>';
                    //     list += '<div class="input-group mb-3">';
                    //         list += '<div class="input-group-prepend" id="button-addon3">';
                    //             list += '<button class="btn btn-outline-secondary" type="button">-</button>';
                    //             list += '<input type="text" class="form-control">';
                    //             list += '<button class="btn btn-outline-secondary" type="button">+</button>'
                    //         list += '</div>';
                    //     list += '</div>';
                    // list += '</td>';
        ...
        $(document).ready(function() {
                    ...
                    if (data.length == 0) {
                        ...
                        $.each(data, function(index, medicine) {
                            ...
                            $.each(medicine.batches, function(key, batch) {
                                ...
                                list += '<div class=col-8>: ' + batch.quantity +
                                    '</div>';
            ...
            $('body').on('click', '.btn-add-medicine', function() {
                ...
                let batchQuantity = $(this).data('batch-quantity');
